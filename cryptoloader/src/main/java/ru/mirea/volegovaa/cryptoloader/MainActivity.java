package ru.mirea.volegovaa.cryptoloader;
...
import ru.mirea.volegovaa.cryptoloader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    public byte[] encryptMsg() {
        ...
        try {
            ...
            return cipher.doFinal(binding.SomeEditText.getText().toString().getBytes());
